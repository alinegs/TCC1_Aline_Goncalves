...
\textcolor{red}{\todo[inline, color=yellow!20]{Aline, aqui cabe uma discussão sobre o fato da equipe ser de especialistas e não generalistas, comum em equipes ágeis. Principal questão: como as atividades foram realizadas com essa configuração de equipe?}}
...
\textcolor{red}{\todo[inline, color=yellow!20]{1)Imagem ruim! Aline, veja com o Baufaker o "truque" que ele descobriu com o Paulo para exportar tabela para o latec. 2) Na prática não é uma figura e sim uma tabela. Contudo, você citou como figura}}
...
\textcolor{red}{\todo[inline, color=yellow!20]{1)Imagem ruim! 2) Mesmo problema da "figura" 15. Na prática não é uma figura e sim uma tabela. Contudo, você citou como figura. 3) Retirar os pontos finais nas colunas atores e papeis. 4) A responsabilidade da EGL não seria de executar o contrato ao invés de acompanhar...?}}
...
\textcolor{red}{\todo[inline, color=yellow!20]{Fazer uma revisão geral, neste capítulo, no que diz respeito ao tempo verbal. Ora é futuro, ora é passado... Sugestão de usar o passado, uma vez que, o projeto já ocorreu. }}
...
A partir dessas premissas definidas, a autarquia construiu um Kanban para auxiliar a Gestão de Demandas.
...
\textcolor{red}{\todo[inline, color=yellow!20]{Precisamos explorar melhor essa discussão aqui. O kanban originalmente vem do LEAN. Além desses dois itens cite os demais princípios/valores do LEAN Development, pois eles aplicam vários outros. Ex: Limitar o trabalho (eles definiram um WIP com APF); Respeito as pessoas (consideram o aprendizado às pessoas, não aplicaram multas punitivas, fvoreceram o fluxo de caixa com os percentuais de pagto; Cadência de propósitos (o controle das OS mensais, com entrega de software funcional) Explore melhor esses e outros pontos. Da maneira como está esta discussão está meio pobre, rasa... É preciso e possível destacar outras evidências.  ) }}
...
\textcolor{red}{\todo[inline, color=yellow!20]{Novamente o problema de figura/tabela, e com qualidade ruim... QE7 e QE9 citando figura X ) }}
...
\textcolor{red}{\todo[inline, color=yellow!20]{Novamente o problema de figura/tabela e qualidade ruim...}}
...
\textcolor{red}{\todo[inline, color=yellow!20]{Importante também destacar que as informações sobre o custo estão presentes somente na documentação do projeto. Fica difícil monitorar,... Uma possível solução automatizada traria maior poder de análise por parte do gestor... ) }}
...
Um dos objetivos científicos do estudo de \citeonline{Meirelles2013} foi a identificação das distribuições estatísticas do valores das métricas apresentadas anteriormente em 38 projetos de software livre, onde foram analisadas XXXX mil \textcolor{red}{Citar a quantidade de classes analisadas. Foram mais de 600K...}. A partir de cada uma das distribuições estatísticas \citeonline{Meirelles2013} classificou as métricas de código fonte de acordo com a frequência dos valores apresentados,
...
intervalos de frequência definidos por \citeonline{Meirelles2013} em em rótulos qualitativos, tal como apresentado na tabela 8. 
...
Posteriormente, é apresentando na tabela 3 \textcolor{red}{conferir número da tabela}, retirada do
estudo de \citeonline{Meirelles2013}, com os intervalos encontrados para C++ e Java. Com isso, os intervalos apresentados na tabela 9 foram os utilizados como os indicadores
...
\textcolor{red}{\todo[inline, color=yellow!20]{tabela/figura...}}
...
\textcolor{red}{\todo[inline, color=yellow!20]{Aline, retirei a apresentação sobre a taxa de oportunidade, pois O Baufaker ainda vai defender e não temos um feedback ainda sobre essa solução}}
...
Assim, no que diz respeito a análise estática do código realizada, a qualidade interna do produto pode ser considerada satisfatória ao compararmos com o melhor software livre encontrado na linguagem de programação Java, de acordo com os estudos de \citeonline{Meirelles2013}. 

Se considerarmos que a métrica COB não tem um peso relevante em comparação as demais métricas e também é satisfatória na percepção dos envolvidos no projeto SICG. \textcolor{red}{Por que ela não é relevante?} No entanto, ao analisarmos que algumas das práticas ágeis adotadas tanto pela empresa quanto pelo órgão são refatoração, código limpo e revisão de código, o resultado obtido por este estudo de caso contradiz a percepção dos envolvidos.

\textcolor{red}{\todo[inline, color=yellow!20]{Esse texto tá meio confuso. Eu não consegui entender direito. Por favor, reescreva. Esse discussão é de extrema importância}}

\textcolor{red}{\todo[inline, color=yellow!20]{Aqui também seria o ponto de discutirmos o fato do software não ter entrado em produção e a falha de desempenho que ele apresentou...}}
