...
A empresa contratada para desenvolvido do projeto foi a empresa EGL - Engenharia. A EGL - Engenharia possui entre 7 e 9 envolvidos no desenvolvido do projeto. O perfil dos envolvidos inclui desenvolvedor, analista de requisitos, designer, testador, scrum master e analista de geo (especialista em sistemas com georeferenciamento).
